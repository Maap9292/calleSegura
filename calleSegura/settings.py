"""
Django settings for calleSegura project.
...
SECRET_KEY = 'django-insecure-)9@$60%brm%qu+bd$=gq^h$yu$*quiq%78#y+hv#z&n4#t&t*z'
...
WSGI_APPLICATION = 'calleSegura.wsgi.application'
